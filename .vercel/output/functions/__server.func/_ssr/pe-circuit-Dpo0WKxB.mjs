...
import { S as playWrong, b as playComplete, c as useScholar, f as outfitById, x as playCorrect } from "./router-JQNCs4HM.mjs";
import { t as Card } from "./card-DQJTLHwf.mjs";
import { t as Button } from "./button-BtPXJ6vz.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/pe-circuit-Dpo0WKxB.js
...
function CadenceStation({ level, onDone, sound }) {
	...
	(0, import_react.useEffect)(() => {
		...
		const loop = (now) => {
			...
			if (now >= beatAt.current + interval * .72 && beatIndex.current < beats) {
