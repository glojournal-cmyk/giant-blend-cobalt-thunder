...
import { C as linkFromHref, _ as nextGarden, a as dueReviewCount, c as useScholar, d as nextOutfit, f as outfitById, g as levelFromXp, h as GARDEN_MILESTONES, m as statFill, o as gameSessionCount, p as scholarLine, s as nextUnlock } from "./router-CdJR-mf5.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-C7Phbwc7.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
				...
				className: "scholar-idle mx-auto block h-[min(72vh,720px)] w-full object-cover object-[50%_18%] outline-none sm:h-[min(78vh,780px)]"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute inset-0 bg-gradient-to-t from-navy via-navy/10 to-transparent" }),
